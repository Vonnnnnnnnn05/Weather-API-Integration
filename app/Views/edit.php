...
<main class="container">
    <div class="header">
        <h1>Edit City</h1>
        <p class="subtitle">Update the selected city details.</p>
    </div>
    ...
    <div class="card">
        ...
        <form action="<?= base_url('weather/update/' . $city['id']); ?>" method="post">
            <?= csrf_field() ?>
            ...
            <div class="row">
                ...
                <input
                    ...
                    placeholder="e.g. PH"
                >
                <div class="hint">Tip: ISO2 like PH/US/JP. Leaving blank still works.</div>
            </div>
